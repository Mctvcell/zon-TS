...
const OUTPUT_FILE = path.join(__dirname, '../datasets/questions-309.js');
...
/**
 * Generates 309 benchmark questions algorithmically.
 */
function generateQuestions() {
  ...
  addQ(`Is the database port '5432' (string)?`, "false", QUESTION_TYPES.FIELD_RETRIEVAL);
