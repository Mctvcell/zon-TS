...
const { encodeToCSV, encodeToTSV } = require('../core/csv-encoder');
...
const { UnifiedSchema } = require('../core/schema-def');

const tson = require('cson');

const OUTPUT_FILE = path.join(__dirname, '../results/accuracy-results.json');
const CONCURRENCY = 1;
...
async function runBenchmark() {
  ...
  // Get questions
  const allQuestions = require('../datasets/questions-309');
